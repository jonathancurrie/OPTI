...
% name = 'libscip';
% opts = [];
% opts.exPP = {'IPOPT_BUILD','FNAME_UCASE_NODECOR','_CRT_SECURE_NO_WARNINGS','NO_RAND_R','NO_SIGACTION','NO_STRERROR_R',...
%              'NO_STRTOK_R','ROUNDING_MS','NPARASCIP','WITH_SCIPDEF','TPI_TNYC','SCIP_BUILDFLAGS="OPTI_BUILD"'};          
% opts.exclude = {'exprinterpret_none.c','nlpi_ipopt_dummy.c','nlpi_filtersqp_dummy.c','nlpi_worhp.c','nlpi_xyz.c','lpi_none.c',...
...
%              'NO_STRTOK_R','ROUNDING_MS','NPARASCIP','TPI_OMP'};
...
% Visual Studio solution file, then complete the following steps:
...
libs = {'libscip','libsoplex','libipoptbm','libfiltersqpsp'};
