...
## QSOPT [Supplied]
<small></small>
QSOPT solves LPs. Fastest LP solver in the OPTI collection for small LPs.
...
bico(at)isye(dot)gatech(dot)edu. You will then be able to download the QSOPT MEX files via an emailed link.
