function [tstop,res] = optiTestSolver(prob,solver,no,wbar)
%OPTITESTSOLVER Perform a speed and accuracy test of an OPTI solver
%
%   [times,results] = optiTestSolver(prob,solver) runs a series of tests 
